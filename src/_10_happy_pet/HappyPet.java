...
public class HappyPet {
	...
	public static void main(String[] args) {
		...
		while (happinessLevel <= 25) {
		  ...
		  if(happinessLevel >= 25) {
			  JOptionPane.showMessageDialog(null,"Your pet likes you");
		  }
		}
	}
	...
	//    and INCREMENT the pet's happiness Level. 
	 ...
	 public static void foodwater() {
		 JOptionPane.showMessageDialog(null,"Your pet might be full");	
		 happinessLevel = happinessLevel + 10;
	 }
	public static void walk() { JOptionPane.showMessageDialog(null, "Your pet might be feeling good");
